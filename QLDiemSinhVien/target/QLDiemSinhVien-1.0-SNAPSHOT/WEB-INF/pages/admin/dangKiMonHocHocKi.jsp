                ...
                <form:form  id = "form" method="post" modelAttribute="phieumonhoc" action="${action}">
                    ...
                    <c:forEach items="${monhoc}" var="mh">
                        ...
                        <tr class="object-row">
                            ...
                            <td>${mh.tenMonHoc}</td>
                            <td>
                                <form:input path="listSoLuong" type="number" class="form-selector" required="true"/>
                            </td>
                            <td>
                                <form:input  id="startDateField" path="listDateBatDau" type="date" class="form-selector" required="true"/>
                            </td>
                            <td>
                                <form:input  id="endDateField" path="listDateKetThuc" type="date" class="form-selector" required="true"/>
                            </td>
                            <td>
