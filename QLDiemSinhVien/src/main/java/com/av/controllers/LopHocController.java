...
public class LopHocController {
    ...
    @ModelAttribute
    public void lophoc(Model model, Map<String, String> params) {
        model.addAttribute("listLopHoc", this.daoTaoService.listLopHoc(params));

    }

    @GetMapping("/giaovu/lophoc")
    public String dslophoc(Authentication auth, Model model, Map<String, String> params, HttpSession session) {
